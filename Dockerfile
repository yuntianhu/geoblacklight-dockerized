...
CMD ["passenger", "start", "--port", "3000", "--log-file", "/dev/stdout", "--no-install-runtime", "--no-compile-runtime","--max-pool-size", "15", "--min-instances", "15", "--nginx-config-template","ops/nginx.conf.erb"]
